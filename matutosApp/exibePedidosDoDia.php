...
<div align="center">
	...
	<thead>
		...
		<th align="center" style='width: 5%;color : black'><div align="center"> FATURAR </div></th>
                <th align="center" style='width: 5%;color : black'><div align="center"> CANCELAR </div></th>
            </tr>
	 </thead>
<?php	
		//$cont =  0;
...
?>
	 	...
	 	<td>
                    <div style="padding: 3px;">
                        <a href="verItensPedido.php?codigoPedido=<?php echo $linha['codigo_pedido']?>&nomeMesa=<?php echo $linha['nome'];?>"><button class="btn btn-info" type="submit">Ver</button></a>
                    </div>
                </td>
                <td>
                    <div style="padding: 3px;">
                        <a href="pedidoController.php?codigoPedido=<?php echo $linha['codigo_pedido']?>&funcao=editarPedido"><button class="btn btn-info" type="submit">Editar</button></a>
                    </div>
                </td>
                <td>
                    <div style="padding: 3px;">
                        <a href="telaDeFaturamento.php?codigoPedido=<?php echo $linha['codigo_pedido']?>&nomeMesa=<?php echo $linha['nome'];?>"><button class="btn btn-info" type="submit">Faturar</button></a>
                    </div>
                </td>
                <td>
                    <div style="padding: 3px;">
                        <a href="pedidoController.php?codigoPedido=<?php echo $linha['codigo_pedido']?>&funcao=cancelarPedido"><button class="btn btn-info" type="submit">Cancelar</button></a>
                    </div>
                </td>
...
<br><br>
<div style="padding: 3px;">
<!--    <a href="gerenciadoDePaginas.php?pagina=cadastroPedido"><button class="btn btn-info" type="submit">Fazer Pedido</button></a>-->
  <a href="gerenciadoDePaginas.php?pagina=fazerPedido"><button class="btn btn-info" type="submit">Fazer Pedido</button></a>
</div>
<br><br>
<?php 
	include 'rodape.php';
